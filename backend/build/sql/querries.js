...
const searchByActor = (params) => __awaiter(void 0, void 0, void 0, function* () {
    const x = yield (0, sql_1.execute)("SELECT A.AID, A.NAME FROM ACTOR A WHERE A.NAME LIKE CONCAT('%', ?, '%');", params);
    console.log(x);
    return x;
});
...
const getActorByAid = (params) => __awaiter(void 0, void 0, void 0, function* () {
    const x = yield (0, sql_1.execute)('SELECT AID, NAME, CREATED, UPDATED FROM ACTOR WHERE AID = ?', params);
    console.log(x);
    return x;
});
